...
const ThreeScene = () => {
  useEffect(() => {
    ...
    const addLights = () => {
        ...
        const lensflareElement = new LensflareElement(textureLoader.load('https://raw.githubusercontent.com/mrdoob/three.js/master/examples/textures/lensflare/lensflare0.png'), 700, 0.0);
    ...
    (function animate() {
        ...
        pointLight.position.set(radius * Math.cos(angle), radius * Math.sin(angle) * 0.95, radius * Math.sin(angle));
        controls.update();
    })();
